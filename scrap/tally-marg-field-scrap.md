# Scrap: Tally Prime / Marg ERP9+ / RetailGraph — Pharmacy Software Field Inventory

Purpose: pull every concrete field, screen, and input surfaced by established Indian pharmacy
retail software (Marg ERP9+, Tally Prime's Pharma ERP, RetailGraph) via public marketing pages,
...
| Field / capability | Marg ERP9+ | Tally Prime | RetailGraph | Metapharsic status |
|---|---|---|---|---|
...
| Field | Marg ERP9+ | Tally Prime | RetailGraph | Metapharsic status |
|---|---|---|---|---|
...
| Drug license no. tied to item/company | Not on item; Tally ties it to the business itself | Yes ("manage drug licence details, renewal alerts, print on invoice") | Not confirmed | **Gap** — no drug-license-number field anywhere (shop's own DL number, not per-medicine) — worth adding as a shop-settings field with renewal-date reminder |
...
| Prescription record with image/scan | Not confirmed for Marg | Yes (per techjockey roundup: "Rx image scanning") | Not confirmed | **Gap** — `prescriptions` table has no file/image column per current screen specs |

## 7. Reports — breadth comparison

| Report type | Marg ERP9+ | Tally Prime | Metapharsic status |
|---|---|---|---|
...
| "1000+ report types" (Marg's own marketing claim) | Yes (marketing number, not itemized) | — | N/A — vendor marketing claim, not a real comparison point |

---

## 8. Net-new gap list (ranked by how much it'd actually help a real shop)

1. **Scheme/offer engine** (buy-N-get-N, slab discounts) — flat % discount only today; Marg leads here.
...
- No paid demo, login-gated admin panel, or full PDF manual was reachable — everything above is
  ...
  failed to render its content (JS-gated), so Marg's *exact* field-by-field screen layout is not
...
- [Marg ERP 9+ Pharmacy Software: Pricing, Features, and Integration in 2026](https://www.softwaresuggest.com/marg-pharmacy)
- [Best Pharmacy Software in India for Billing Management 2026 (Marg)](https://margcompusoft.com/pharmacy-software.html)
- [MARG ERP Pharmacy Software with Batch & Expiry Tracking](https://margerpmaharashtra.in/pharmacy-software/)
- [MARG ERP9+ Pharmaceutical Distribution — SoftwareSuggest](https://www.softwaresuggest.com/marg-pharmaceutical)
- [MARG Software User Training Guide (Scribd)](https://www.scribd.com/document/81622141/MARGMANUAL)
- [Pharmacy & Hospital Billing Software — Tally Solutions](https://tallysolutions.com/billing-software/pharmacy-hospital-billing-software/)
- [Best Pharma ERP Software: Features, Benefits & Compliance Guide — Tally Solutions](https://tallysolutions.com/accounting-software/pharma-erp-software/)
- [23 Best Pharmacy Management Systems in India — Techjockey](https://www.techjockey.com/blog/top-retail-pharma-management-software)
- [RetailGraph Pricing, Features, Reviews & Ratings — Capterra India](https://www.capterra.in/software/136947/retailgraph)
