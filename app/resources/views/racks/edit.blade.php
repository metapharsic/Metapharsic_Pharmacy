<x-app-layout>
    <x-page-header :title="'Edit Rack'" :breadcrumbs="[
        ['label' => 'Racks', 'url' => route('racks.index')],
        ...
        <div class="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
            <form method="POST" action="{{ route('racks.update', $rack) }}">
                ...
                <div class="mt-6 flex items-center gap-3">
                    ...
                    <a href="{{ route('racks.index') }}" class="text-sm text-slate-600 hover:underline">Cancel</a>
                </div>
            </form>
        </div>
    </div>
